...
impl MemoryStartupContext {
    ...
    pub(crate) async fn stage_one_request_context(
        ...
        // default). Matches session-init enrichment in session/mod.rs.
    ...
    pub(crate) async fn stream_stage_one_prompt(
        ...
        let mut stream = client_session
            .stream(
                ...
                // Memories write does not use custom cache retention or effort overrides.
                /*cache_retention*/ None,
                /*cache_retention_by_block*/ Default::default(),
                /*model_effort*/ None,
            )
            .await?;
