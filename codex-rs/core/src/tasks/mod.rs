        ...
        // Emit token usage metrics.
        {
            ...
            let turn_token_usage = TokenUsage {
                ...
                total_tokens: (total_token_usage.total_tokens
                    ...
                    .max(0),
                web_search_requests: (total_token_usage.web_search_requests
                    - token_usage_at_turn_start.web_search_requests)
                    .max(0),
                web_fetch_requests: (total_token_usage.web_fetch_requests
                    - token_usage_at_turn_start.web_fetch_requests)
                    .max(0),
            };
