...
#[tokio::test]
async fn temperature_loads_from_config_toml() -> std::io::Result<()> {
    let cfg: ConfigToml = toml::from_str(
        r#"
temperature = 0.0
"#,
...
#[tokio::test]
async fn top_p_loads_from_config_toml() -> std::io::Result<()> {
    let cfg: ConfigToml = toml::from_str(
        r#"
top_p = 0.9
"#,
...
#[tokio::test]
async fn top_k_loads_from_config_toml() -> std::io::Result<()> {
    let cfg: ConfigToml = toml::from_str(
        r#"
top_k = 40
"#,
...
#[tokio::test]
async fn all_sampling_params_load_together() -> std::io::Result<()> {
    let cfg: ConfigToml = toml::from_str(
        r#"
temperature = 0.7
top_p = 0.95
...
#[tokio::test]
async fn sampling_params_default_to_none() -> std::io::Result<()> {
...
#[tokio::test]
async fn sampling_params_temperature_zero_is_valid() -> std::io::Result<()> {
...
#[tokio::test]
async fn tool_choice_auto_from_toml() {
...
#[tokio::test]
async fn tool_choice_required_from_toml() {
    let codex_home = tempdir().unwrap();
    let config_path = codex_home.path().join(CONFIG_TOML_FILE);
    std::fs::write(
        &config_path,
...
#[tokio::test]
async fn tool_choice_none_from_toml() {
    let codex_home = tempdir().unwrap();
    let config_path = codex_home.path().join(CONFIG_TOML_FILE);
    std::fs::write(
        &config_path,
...
#[tokio::test]
async fn tool_choice_specific_from_toml() {
    let codex_home = tempdir().unwrap();
    let config_path = codex_home.path().join(CONFIG_TOML_FILE);
    std::fs::write(
        &config_path,
...
#[tokio::test]
async fn tool_choice_absent_from_toml_yields_none() {
    let codex_home = tempdir().unwrap();
    let config_path = codex_home.path().join(CONFIG_TOML_FILE);
