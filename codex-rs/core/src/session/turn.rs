    ...
    loop {
        ...
        .await
        {
            Ok(sampling_request_output) => {
                ...
                // XLI: loop detection fired during sampling — inject loop-break message.
                if loop_detected && needs_follow_up {
                ...
                if !needs_follow_up {
                    // XLI: circuit breaker — detect death spiral of consecutive empty responses.
                    {
