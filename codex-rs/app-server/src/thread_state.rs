...
mod turn_summary_tests {
    ...
    #[test]
    fn turn_started_resets_stale_turn_summary_state() {
        let mut state = ThreadState::default();
        state.turn_summary.started_at = Some(7);
        ...
        assert_eq!(state.turn_summary.last_error, None);
