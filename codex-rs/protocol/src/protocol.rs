...
/// Bridge: canonical token usage in `codex_wire_extensions` (S-WI-07-PRE-2).
pub use codex_wire_extensions::WireTokenUsage as TokenUsage;
...
pub enum SubAgentSource {
    ...
    ThreadSpawn {
        ...
        /// Parent call_id of the spawn_agent invocation when fork_context is set.
        #[serde(default)]
        #[ts(optional)]
